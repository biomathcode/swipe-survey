...
function Privacy() {
  return (
    <>
      <Header />
      <div className="markdown-body max-w-2xl">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to SwipeSurvey.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to SwipeSurvey, accessible from{" "}
              <a
                href="https://swipe-survey.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://swipe-survey.vercel.app/
              </a>
            </p>
          </li>
          <li>
